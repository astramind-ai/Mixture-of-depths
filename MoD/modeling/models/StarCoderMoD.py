...
class Starcoder2Model(Starcoder2PreTrainedModel):
    ...
    def __init__(self, config: Starcoder2Config):
        ...
        self.layers = nn.ModuleList(
            [Starcoder2DecoderLayer(config, layer_idx) if layer_idx % 2 == 0 else MoD(0.125,Starcoder2DecoderLayer(config, layer_idx)) for layer_idx in range(config.num_hidden_layers)]
        )
...
class Starcoder2MoDForCausalLM(Starcoder2PreTrainedModel):
