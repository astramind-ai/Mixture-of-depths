...
class Qwen2MoDMoeForCausalLM(Qwen2MoePreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers import AutoTokenizer, Qwen2MoeForCausalLM # noqa

        >>> model = Qwen2MoDMoeForCausalLM.from_pretrained(PATH_TO_CONVERTED_WEIGHTS)
