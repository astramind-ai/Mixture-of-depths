...
class MixtralModel(MixtralPreTrainedModel):
    ...
    def __init__(self, config: MixtralConfig):
        ...
        self.layers = nn.ModuleList(
            [MixtralDecoderLayer(config, layer_idx) if layer_idx % 2 ==0 else MoD(0.125, MixtralDecoderLayer(config, layer_idx)) for layer_idx in range(config.num_hidden_layers)]
        )
...
class MixtralMoDForCausalLM(MixtralPreTrainedModel):
