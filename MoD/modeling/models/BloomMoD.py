...
class BloomModel(BloomPreTrainedModel):
    def __init__(self, config: BloomConfig):
        ...
        # Transformer blocks
        self.h = nn.ModuleList([BloomBlock(config) if _ % 2 == 0 else MoD(0.125, BloomBlock(config)) for _ in range(config.num_hidden_layers)])
...
class BloomMoDForCausalLM(BloomPreTrainedModel):
