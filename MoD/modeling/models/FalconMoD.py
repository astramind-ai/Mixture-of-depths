...
class FalconModel(FalconPreTrainedModel):
    def __init__(self, config: FalconConfig):
        ...
        # Transformer blocks
        self.h = nn.ModuleList([FalconDecoderLayer(config) if _ % 2 == 0 else MoD(0.125, FalconDecoderLayer(config)) for _ in range(config.num_hidden_layers)])
...
class FalconMoDForCausalLM(FalconPreTrainedModel):
